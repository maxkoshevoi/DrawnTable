...
namespace DrawnTableControl
{
    ...
    public class PBDrawnTable : PictureBox
    {
        ...
        // Cell is being copied using Drag&Drop
        [MemberNotNullWhen(true, nameof(copySource), nameof(interactWith))]
        private bool copyMode_DrugDrop { get; set; }
        ...
        {
            _ = dragBackground ?? throw new NullReferenceException(nameof(dragBackground));
            _ = interactWith ?? throw new NullReferenceException(nameof(interactWith));
